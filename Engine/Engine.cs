...
namespace EvllyEngine
{
    public class Engine : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            //GameObjects[0]._transform._Rotation = new Quaternion(MathHelper.DegreesToRadians(moveVector.Y), MathHelper.DegreesToRadians(moveVector.X), MathHelper.DegreesToRadians(0.0f), 0);
            GameObjects[2]._transform._Position = new Vector3(moveVector.X, moveVector.Y, 0);
