    ...
    public class Camera
    {
        ...
        public void Update(float time)
        {
            ...
            if (MouseLook)
            {
                ...
                {
                    deltaX = Input.GetMouse.XDelta - (Engine.Instance.Width / 2);
                    deltaY = Input.GetMouse.YDelta - (Engine.Instance.Height / 2);
                    ...
                    //gameObject._transform._Rotation = new Quaternion(MathHelper.DegreesToRadians(0.0f), MathHelper.DegreesToRadians(0.0f), MathHelper.DegreesToRadians(0.0f), 0);
        ...
        private void UpdateViewMatrix()
        {
            ...
            viewMatrix = Matrix4.LookAt(gameObject._transform._Position, finalTarget, _up);
        }
        ...
        public Matrix4 GetProjection { get { return _projection; } }
